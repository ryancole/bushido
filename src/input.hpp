...
private:
    ...
    // The press-fired edges added after drop, all on the same held/pending
    // latch pattern it uses: a press sits until a fixed step consumes it.
    bool m_stanceUpHeld = false;
